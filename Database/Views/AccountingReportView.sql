...
Objects: VIEW
*/
CREATE VIEW [dbo].[AccountingReportView]
AS

SELECT DISTINCT
	dbo.AccountingBillingPerType.BillingPerTypeName,
	dbo.Accounting.CustomerName,
	dbo.Accounting.ID AS CustomerID,
...
FROM dbo.AccountingBillingPerType
	 INNER JOIN dbo.Accounting ON dbo.AccountingBillingPerType.BillingPerTypeID = dbo.Accounting.BillingPer 
					AND Accounting.Deleted = 0 AND Accounting.CustomerType = 1
	 INNER JOIN dbo.Agency ON dbo.Accounting.ID = dbo.Agency.AgencyID 
