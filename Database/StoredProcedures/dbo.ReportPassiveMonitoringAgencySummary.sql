...
Objects: PROCEDURE
*/
CREATE PROCEDURE [ReportPassiveMonitoringAgencySummary]
...
AND (cbs.Serviceid = 2 OR @Agencyid IN (1450,1566))
...
GO
GRANT EXECUTE ON [ReportPassiveMonitoringAgencySummary] TO [db_dml]
GO
