...
Objects: PROCEDURE
*/
CREATE PROCEDURE [UpdateStreetAddressCache2]
...
INSERT INTO dbo.StreetAddressCache (Latitude, Longitude, Date)
    SELECT DISTINCT TOP (@RowCount)
		...
		,@Date
    FROM dbo.rprtEventsBucket2 eb1
    WHERE NOT EXISTS (
...
GO
GRANT EXECUTE ON [UpdateStreetAddressCache2] TO [db_dml]
GO
GRANT VIEW DEFINITION ON [UpdateStreetAddressCache2] TO [db_object_def_viewers]
GO
