...
Objects: PROCEDURE
*/
CREATE PROCEDURE [OperatorUpdatePriorityContact]
@OperatorID int,
...
BEGIN
	SET NOCOUNT ON;
IF (SELECT Count(*) FROM PriorityContact WHERE OperatorID = @OperatorID) > 0
BEGIN
...
ELSE
BEGIN
INSERT INTO PriorityContact (OperatorID,PriorityContactType1,PriorityContactType2,
...
VALUES(@OperatorID,@ContactType1,@ContactType2, @ContactType3, @ContactType4, 
...
GO
GRANT VIEW DEFINITION ON [OperatorUpdatePriorityContact] TO [db_object_def_viewers]
GO
GRANT EXECUTE ON [OperatorUpdatePriorityContact] TO [db_dml]
GO
