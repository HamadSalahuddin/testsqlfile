...
Objects: PROCEDURE
*/
CREATE PROCEDURE [ReportActiveInterventionOfficerSummary]
...
Where tmp.Officerid = @Officerid AND o.agencyid = @Agencyid
...
GO
GRANT EXECUTE ON [ReportActiveInterventionOfficerSummary] TO [db_dml]
GO
