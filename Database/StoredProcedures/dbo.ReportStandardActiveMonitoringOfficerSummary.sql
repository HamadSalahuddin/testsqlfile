...
Objects: PROCEDURE
*/
CREATE PROCEDURE [ReportStandardActiveMonitoringOfficerSummary]
...
Where o.deleted = 0 ANd tmp.Officerid = @Officerid AND o.agencyid = @Agencyid AND cbs.serviceid = 3
...
GO
GRANT EXECUTE ON [ReportStandardActiveMonitoringOfficerSummary] TO [db_dml]
GO
