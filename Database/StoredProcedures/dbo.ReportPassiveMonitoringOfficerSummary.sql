...
Objects: PROCEDURE
*/
CREATE PROCEDURE [ReportPassiveMonitoringOfficerSummary]
...
Where o.deleted = 0 ANd tmp.Officerid = @Officerid AND o.agencyid = @Agencyid AND cbs.serviceid = 2
...
GO
GRANT EXECUTE ON [ReportPassiveMonitoringOfficerSummary] TO [db_dml]
GO
