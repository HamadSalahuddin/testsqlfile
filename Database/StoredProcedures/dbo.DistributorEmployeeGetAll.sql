...
Objects: PROCEDURE
*/
CREATE PROCEDURE [DistributorEmployeeGetAll]
AS
BEGIN
	SET NOCOUNT ON;
	...
	SELECT 	u.UserID AS 'DistributorEmployeeUserID',
			...
			ISNULL(d.DistributorName, '') AS 'DistributorName',
...
END
GO
GRANT VIEW DEFINITION ON [DistributorEmployeeGetAll] TO [db_object_def_viewers]
GO
GRANT EXECUTE ON [DistributorEmployeeGetAll] TO [db_dml]
GO
