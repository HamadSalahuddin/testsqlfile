...
--GO
CREATE PROCEDURE [TotalAlarmsByHalfHour]
...
AS
SELECT
CONVERT(CHAR(5),DATEADD(MINUTE,FLOOR(DATEDIFF(MINUTE,'20000101',a.EventDisplayTime)/30.0)*30
,'20000101'),108) AS 'Date'
...
Where DATEADD(mi,-360,EventDisplayTime) BETWEEN @Date AND DATEADD(dd,1,@Date) 
...
GO
GRANT EXECUTE ON [TotalAlarmsByHalfHour] TO [db_dml]
GO
