...
Objects: PROCEDURE
*/
CREATE PROCEDURE [EventGetByAgencyID]
...
WHERE EventDateTime BETWEEN @StartDate AND @EndDate AND AgencyID = @AgencyID
UNION
SELECT *
...
WHERE
--	((@AgencyID = 0) OR (e.AgencyID = @AgencyID)) AND
...
GO
GRANT EXECUTE ON [EventGetByAgencyID] TO [db_dml]
GO
GRANT VIEW DEFINITION ON [EventGetByAgencyID] TO [db_object_def_viewers]
GO
