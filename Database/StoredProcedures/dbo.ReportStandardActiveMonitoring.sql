...
Objects: PROCEDURE
*/
CREATE PROCEDURE [ReportStandardActiveMonitoring]
...
AND rpt.Agencyid = @Agencyid AND rpt.alarmtype > 1 And cbs.Serviceid = 3
--And ags.Serviceid = 1
ORDER BY ofi.LastName+', '+ofi.FirstName,o.LastName+', '+o.FirstName,rpt.EventDateTime


GO
GRANT EXECUTE ON [ReportStandardActiveMonitoring] TO [db_dml]
GO
