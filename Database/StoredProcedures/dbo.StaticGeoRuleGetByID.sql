...
Objects: PROCEDURE
*/
CREATE PROCEDURE [StaticGeoRuleGetByID]
...
GO
GRANT VIEW DEFINITION ON [StaticGeoRuleGetByID] TO [db_object_def_viewers]
GO
GRANT EXECUTE ON [StaticGeoRuleGetByID] TO [db_dml]
GO
