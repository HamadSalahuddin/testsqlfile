...
Objects: PROCEDURE
*/
CREATE PROCEDURE [ReportDeviceSummary]
	@StartDate		DateTime,
	@EndDate		DateTime,
	@TimezoneOffset int
...
GO
GRANT VIEW DEFINITION ON [ReportDeviceSummary] TO [db_object_def_viewers]
GO
GRANT EXECUTE ON [ReportDeviceSummary] TO [db_dml]
GO
