...
Objects: PROCEDURE
*/
CREATE PROCEDURE [OfficerGetOfficersByAgencyID]
	@AgencyID int
...
AS
	...
	FROM	Officer o
	WHERE	AgencyID = @AgencyID and o.Deleted = 0
    ORDER BY 'FirstName','MiddleName','LastName'
GO
GRANT EXECUTE ON [OfficerGetOfficersByAgencyID] TO [db_dml]
GO
GRANT VIEW DEFINITION ON [OfficerGetOfficersByAgencyID] TO [db_object_def_viewers]
GO
